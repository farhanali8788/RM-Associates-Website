(() => {
  ...
  var r = function e(t, r) {
    ...
    if (t && r && "object" == typeof t && "object" == typeof r) {
      ...
      if ((i = (o = Object.keys(t)).length) !== Object.keys(r).length)
        return !1;
      for (s = i; 0 != s--; )
  ...
  class o {
    constructor({
      ...
      if (
        ...
        if (!r(this.options, o.instance.options))
          throw new Error(
            `Loader must not be called again with different options. ${JSON.stringify(
              this.options
            )} !== ${JSON.stringify(o.instance.options)}`
          );
        return o.instance;
      }
      o.instance = this;
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    (e = "#map"),
      (r = new o({
        apiKey: "AIzaSyCCek6jsfOYOK2lAtNP8I5Fuy4FOvBgghk",
        version: "weekly",
      })),
      (i = document.querySelector(e)),
      (s = { lat: 40.74881584652125, lng: -73.98561648634562 }),
      i &&
        r.load().then(function () {
          var e = {
            ...
            r = new google.maps.Map(i, {
              center: { lat: 40.74956081164776, lng: -73.98700531672688 },
              zoom: 12,
              styles: t(l),
              disableDefaultUI: !0,
            });
          new google.maps.Marker({ position: s, map: r, icon: e });
        });
  });
})();
